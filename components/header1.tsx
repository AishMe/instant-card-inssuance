...
const Header1: NextPage<Header1Type> = ({ services, parentOfAllPadding }) => {
  ...
  return (
    <header className="self-stretch flex flex-row items-center justify-start pt-[1.25rem] pb-[0rem] pr-[0rem] pl-[2.563rem] box-border gap-[3.438rem] max-w-full z-[2] text-left text-[1.563rem] text-primary-2 font-montserrat mq750:gap-[3.438rem]">
      ...
      <div className="flex-1 flex flex-col items-start justify-start pt-[0rem] px-[0rem] pb-[0rem] box-border max-w-full text-[1.75rem] font-heading-four-semibold-20p">
