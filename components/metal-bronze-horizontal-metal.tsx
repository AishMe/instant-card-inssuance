...
const MetalBronzeHorizontalMetal: NextPage = () => {
  return (
    <div className="w-[35.875rem] flex flex-col items-center justify-start pt-[2.75rem] px-[0rem] pb-[0rem] box-border relative gap-[2.5rem_0rem] min-w-[35.875rem] max-w-full z-[1] text-left text-[1.25rem] text-label-color-light-primary font-heading-four-semibold-20p mq1050:flex-1 mq1050:min-w-full mq450:pt-[1.813rem] mq450:box-border mq750:gap-[2.5rem_0rem]">
      ...
      <div className="w-[30.875rem] flex flex-col items-start justify-start gap-[0.75rem_0rem] max-w-full">
        <div className="self-stretch flex flex-col items-end justify-start">
          <div className="rounded-lg bg-gray-1800 overflow-hidden flex flex-row items-start justify-start py-[0rem] pr-[0.125rem] pl-[0rem] gap-[0rem_0.75rem] z-[1] border-[2px] border-solid border-gray-1700">
            <img
      ...
      <div className="self-stretch rounded-t-none rounded-b-13xl bg-gray-300 overflow-hidden flex flex-row items-start justify-between pt-[1.75rem] px-[2.5rem] pb-[1.625rem] relative gap-[1.25rem] z-[1] text-silver mq450:flex-wrap">
        <img
        ...
        <div className="h-[3.625rem] w-[5rem] flex flex-col items-start justify-start pt-[0.125rem] px-[0rem] pb-[0rem] box-border">
          <img
...
export default MetalBronzeHorizontalMetal;
